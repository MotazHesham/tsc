...
class ContractsController extends Controller
{
    ...
    { 
        ...
        if ($request->ajax()) {
            $query = Contract::with(['user', 'request_service'])->where('user_id',auth()->id())->select(sprintf('%s.*', (new Contract)->table));
    ...
    { 
        ...
        return view('client.contracts.create', compact('request_services', 'users'));
    }
    ...
    { 
        ...
        return view('client.contracts.edit', compact('contract', 'request_services', 'users'));
    }
