...
class MessengerController extends Controller
{
    public function index()
    {
        ...
        return view('technical.messenger.index', compact('topics', 'title', 'unreads'));
    }
    ...
    public function createTopic()
    {
        ...
        return view('technical.messenger.create', compact('users', 'unreads'));
    }
    ...
    public function storeTopic(QaTopicCreateRequest $request)
    {
        ...
        return redirect()->route('technical.messenger.index');
    }
    ...
    public function showMessages(QaTopic $topic)
    {
        ...
        return view('technical.messenger.show', compact('topic', 'unreads'));
    }
    ...
    public function showReply(QaTopic $topic)
    {
        ...
        return view('technical.messenger.reply', compact('topic', 'unreads'));
    }
