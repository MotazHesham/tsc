...
<div class="card">
    ...
    <div class="card-body">
        <div class="form-group">
            <div class="form-group">
                <a class="btn btn-default" href="{{ route('client.contracts.index') }}">
...
<div class="card">
    ...
    <div class="tab-content">
        <div class="tab-pane" role="tabpanel" id="contract_appointments">
            @includeIf('client.contracts.relationships.contractAppointments', ['appointments' => $contract->contractAppointments])
        </div>
    </div>
</div>
