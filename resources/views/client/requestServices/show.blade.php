...
<div class="card">
    ...
    <div class="card-body">
        <div class="form-group">
            ...
            <div>
                @if($requestService->status == 'pending' || $requestService->status == 'edit')
                    @if($requestService->offer_price_file || $requestService->offer_price)
                        <a class="btn btn-success" href="{{ route('client.request-services.change_status',['status' => 'accept' , 'id' => $requestService->id]) }}">
                            موافقة
                        </a> 
                        <a class="btn btn-danger text-white" href="{{ route('client.request-services.change_status',['status' => 'refuse' , 'id' => $requestService->id]) }}">
                            رفض
                        </a> 
                        <a class="btn btn-info" href="{{ route('client.request-services.change_status',['status' => 'edit' , 'id' => $requestService->id]) }}">
                            طلب تعديل
                        </a> 
                    @endif 
                @endif
