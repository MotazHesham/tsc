            ...
            <form method="POST" action="{{ route('admin.request-services.update', [$requestService->id]) }}"
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <div class="needsclick dropzone {{ $errors->has('visiting_form') ? 'is-invalid' : '' }}"
                            id="visiting_form-dropzone">
                        </div>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="needsclick dropzone {{ $errors->has('offer_price_file') ? 'is-invalid' : '' }}"
                            id="offer_price_file-dropzone">
                        </div>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-control {{ $errors->has('offer_price') ? 'is-invalid' : '' }}" type="number"
                            name="offer_price" id="offer_price" value="{{ old('offer_price', $requestService->offer_price) }}"
                            step="0.01">
