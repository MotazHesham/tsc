    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.request-services.update", [$requestService->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('message') ? 'is-invalid' : '' }}" name="message" id="message" required>{{ old('message', $requestService->message) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('offer_price') ? 'is-invalid' : '' }}" type="number" name="offer_price" id="offer_price" value="{{ old('offer_price', $requestService->offer_price) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('edits') ? 'is-invalid' : '' }}" name="edits" id="edits">{{ old('edits', $requestService->edits) }}</textarea>
                @if($errors->has('edits'))
                    <div class="invalid-feedback">
                        {{ $errors->first('edits') }}
                    </div>
