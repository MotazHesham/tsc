    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.abouts.update", [$about->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('site_name') ? 'is-invalid' : '' }}" type="text" name="site_name" id="site_name" value="{{ old('site_name', $about->site_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email" name="email" id="email" value="{{ old('email', $about->email) }}">
                @if($errors->has('email'))
                    <div class="invalid-feedback">
                        {{ $errors->first('email') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone') ? 'is-invalid' : '' }}" type="text" name="phone" id="phone" value="{{ old('phone', $about->phone) }}">
                @if($errors->has('phone'))
                    <div class="invalid-feedback">
                        {{ $errors->first('phone') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone_2') ? 'is-invalid' : '' }}" type="text" name="phone_2" id="phone_2" value="{{ old('phone_2', $about->phone_2) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}" name="address" id="address">{{ old('address', $about->address) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('footer_description') ? 'is-invalid' : '' }}" name="footer_description" id="footer_description">{{ old('footer_description', $about->footer_description) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('how_do_we_work_video') ? 'is-invalid' : '' }}" type="text" name="how_do_we_work_video" id="how_do_we_work_video" value="{{ old('how_do_we_work_video', $about->how_do_we_work_video) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('count_experience') ? 'is-invalid' : '' }}" type="text" name="count_experience" id="count_experience" value="{{ old('count_experience', $about->count_experience) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('count_projects') ? 'is-invalid' : '' }}" type="text" name="count_projects" id="count_projects" value="{{ old('count_projects', $about->count_projects) }}">
