        ...
        <form method="POST" action="{{ route("admin.services.update", [$service->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('featured') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="featured" id="featured" value="1" {{ $service->featured || old('featured', 0) === 1 ? 'checked' : '' }}>
                    <label class="form-check-label" for="featured">{{ trans('cruds.service.fields.featured') }}</label>
                </div>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.service.fields.featured_helper') }}</span>
            </div>
            <div class="form-group">
