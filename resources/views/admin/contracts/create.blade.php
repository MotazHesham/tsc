            ...
            <form method="POST" action="{{ route('admin.contracts.store') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select class="form-control {{ $errors->has('contract_type') ? 'is-invalid' : '' }}"
                            ...
                            @foreach (App\Models\Contract::CONTRACT_TYPE_SELECT as $key => $label)
                                <option value="{{ $key }}"
                                    {{ old('contract_type', 'once') === (string) $key ? 'selected' : '' }}>
                                    {{ $label }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select class="form-control select2 {{ $errors->has('request_service') ? 'is-invalid' : '' }}"
                            name="request_service_id" id="request_service_id">
                            @foreach ($request_services as $id => $entry)
                                <option value="{{ $id }}"
                                    {{ old('request_service_id') == $id ? 'selected' : '' }}>{{ $entry }}
                                    @if (!$loop->first)
                                        (#{{ $id }})
                                    @endif
                                </option>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input class="form-control {{ $errors->has('contract_value') ? 'is-invalid' : '' }}" type="number"
                            name="contract_value" id="contract_value" value="{{ old('contract_value', '') }}"
                            step="0.01">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input class="form-control {{ $errors->has('mngr_name') ? 'is-invalid' : '' }}" type="text"
                            name="mngr_name" id="mngr_name" value="{{ old('mngr_name', '') }}" required>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input class="form-control {{ $errors->has('mngr_email') ? 'is-invalid' : '' }}" type="text"
                            name="mngr_email" id="mngr_email" value="{{ old('mngr_email', '') }}">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input class="form-control {{ $errors->has('mngr_phone') ? 'is-invalid' : '' }}" type="text"
                            name="mngr_phone" id="mngr_phone" value="{{ old('mngr_phone', '') }}">
