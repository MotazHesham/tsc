    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.contracts.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('contract_type') ? 'is-invalid' : '' }}" name="contract_type" id="contract_type" required>
                    ...
                    @foreach(App\Models\Contract::CONTRACT_TYPE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('contract_type', 'once') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('request_service') ? 'is-invalid' : '' }}" name="request_service_id" id="request_service_id">
                    @foreach($request_services as $id => $entry)
                        <option value="{{ $id }}" {{ old('request_service_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mngr_name') ? 'is-invalid' : '' }}" type="text" name="mngr_name" id="mngr_name" value="{{ old('mngr_name', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mngr_email') ? 'is-invalid' : '' }}" type="text" name="mngr_email" id="mngr_email" value="{{ old('mngr_email', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mngr_phone') ? 'is-invalid' : '' }}" type="text" name="mngr_phone" id="mngr_phone" value="{{ old('mngr_phone', '') }}">
