<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show" style="background: white;">
    ...
    <ul class="c-sidebar-nav">
        ...
        @can('user_management_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/permissions*") ? "c-show" : "" }} {{ request()->is("admin/roles*") ? "c-show" : "" }} {{ request()->is("admin/users*") ? "c-show" : "" }} {{ request()->is("admin/technicals*") ? "c-show" : "" }} {{ request()->is("admin/audit-logs*") ? "c-show" : "" }}">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    ...
                    @endcan
                    @can('technical_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.technicals.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/technicals") || request()->is("admin/technicals/*") ? "c-active" : "" }}">
                                <i class="fa-fw fas fa-user-cog c-sidebar-nav-icon">

                                </i>
                                {{ trans('cruds.technical.title') }}
                            </a>
                        </li>
                    @endcan
        ...
        @can('client_managment_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/clients*") ? "c-show" : "" }} {{ request()->is("admin/request-services*") ? "c-show" : "" }} {{ request()->is("admin/contracts*") ? "c-show" : "" }} {{ request()->is("admin/appointments*") ? "c-show" : "" }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
        ...
        @can('general_setting_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/sliders*") ? "c-show" : "" }} {{ request()->is("admin/services*") ? "c-show" : "" }} {{ request()->is("admin/contactus*") ? "c-show" : "" }} {{ request()->is("admin/abouts*") ? "c-show" : "" }} {{ request()->is("admin/team-works*") ? "c-show" : "" }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    ...
                    @endcan
                    @can('team_work_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.team-works.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/team-works") || request()->is("admin/team-works/*") ? "c-active" : "" }}">
                                <i class="fa-fw fas fa-chalkboard-teacher c-sidebar-nav-icon">

                                </i>
                                {{ trans('cruds.teamWork.title') }}
                            </a>
                        </li>
                    @endcan
                </ul>
