...
<head>
    ...
    <style>
        ...
        .card-header {
            ...
            box-shadow: 1px 8px 12px #cdcdcd;
            text-align: center;
        }

        .shadow-2 {
            box-shadow: 6px 4px 1px #00000063;
        }
    </style>
</head>

<body class="c-app">
    @include('partials.technical_menu')
    <div class="c-wrapper">
        <header class="c-header c-header-fixed px-3" style="background: #f1f6f9 !important;border: none;">
